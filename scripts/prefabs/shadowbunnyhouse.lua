...
local assets =
{
    Asset("ANIM", "anim/shadowbunnyhouse.zip"),
...
--{anim="level1", sound="dontstarve/common/campfire", radius=2, intensity=.75, falloff=.33, colour = {197/255,197/255,170/255}},
    ...
    inst.AnimState:SetBuild("shadowbunnyhouse")
    ...
    inst.components.spawner:Configure("shadowbunnyman", TUNING.RABBITHOUSE_SPAWN_TIME * 2)
...
return Prefab("shadowbunnyhouse", fn, assets, prefabs)
-- -- ,
