...
local EverythingBunnymanBrain = Class(Brain, function(self, inst)
    Brain._ctor(self, inst)
end)

function EverythingBunnymanBrain:OnStart()
    ...
    PriorityNode(
        {
            ...
            WhileNode(function() return not self.inst.beardlord and not TheWorld.state.isday end, "IsNight",
...
return EverythingBunnymanBrain
