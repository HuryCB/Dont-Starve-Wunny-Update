...
local SnakeKingBrain = Class(Brain, function(self, inst)
	Brain._ctor(self, inst)
end)

local SEE_DIST = 30
local MAX_CHASE_TIME = 8
local MAX_CHASE_DIST = TUNING.SNAKE_KEEP_TARGET_DIST * TUNING.SNAKE_KEEP_TARGET_DIST
...
-- Note that this function is unused in SW too.
...
function SnakeKingBrain:OnStart()
